...
<%
    // Obtener el cliente desde la sesi�n
    ...
    <body>
        ...
        <div class="payment-container">
            ...
            <div class="qr-image" id="qr-image">
                <h3>Escanea el c�digo QR para pagar en efectivo</h3>
                <img src="${pageContext.request.contextPath}/resources/img/payments/qr_yape.jpg" alt="C�digo QR">
            </div>
        </div>
